...
if __name__ == '__main__':
    ...
    episode_reward_pub = rospy.Publisher(
        '/monoped/episode_reward', Float64, queue_size=1)
    ...
    for x in range(nepisodes):
        ...
        for i in range(nsteps):
            ...
            rospy.logdebug(
                "env.get_state...[distance_from_desired_point,base_roll,base_pitch,base_yaw,contact_force,joint_states_haa,joint_states_hfe,joint_states_kfe]==>" + str(nextState))
