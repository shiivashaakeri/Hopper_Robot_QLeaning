...
class MonopedState(object):
    ...
    def __init__(self, max_height, min_height, abs_max_roll, abs_max_pitch, joint_increment_value=0.05, done_reward=-1000.0, alive_reward=10.0, desired_force=7.08, desired_yaw=0.0, weight_r1=1.0, weight_r2=1.0, weight_r3=1.0, weight_r4=1.0, weight_r5=1.0, discrete_division=10):
        ...
        self.desired_world_point = Vector3()
        self.desired_world_point.x = 0.0
        self.desired_world_point.y = 0.0
        self.desired_world_point.z = 0.0
        ...
        rospy.Subscriber("/lowerleg_contactsensor_state",
                         ContactsState, self.contact_callback)
    ...
    def check_all_systems_ready(self):
        ...
        while imu_data is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logdebug(
                    "Current imu_data not ready yet, retrying for getting robot base_orientation, and base_linear_acceleration")
    ...
    def calculate_reward_joint_effort(self, weight=1.0):
        ...
        for joint_effort in self.joints_state.effort:
            ...
            rospy.logdebug(
                "calculate_reward_joint_effort>>joint_effort=" + str(joint_effort))
            rospy.logdebug(
                "calculate_reward_joint_effort>>acumulated_joint_effort=" + str(acumulated_joint_effort))
    ...
    def calculate_reward_orientation(self, weight=1.0):
        ...
        rospy.logdebug(
            "calculate_reward_orientation>>[R,P,Y]=" + str(curren_orientation))
        acumulated_orientation_displacement = abs(
            curren_orientation.x) + abs(curren_orientation.y) + abs(yaw_displacement)
    ...
    def get_observations(self):
        ...
        for obs_name in self._list_of_observations:
            if obs_name == "distance_from_desired_point":
                ...
                raise NameError(
                    'Observation Asked does not exist=='+str(obs_name))
    ...
    def create_bins(self):
        ...
        for counter in range(number_of_observations):
            ...
            self._bins[counter] = numpy.linspace(
                min_value, max_value, parts_we_disrcetize)
